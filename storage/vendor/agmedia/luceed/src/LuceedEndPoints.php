...
class LuceedEndPoints
{
    ...
    private static function local(): array
    {
        return [
            ...
            'product_related'   => 'related.json',
            'product_action_30' => 'akcijske_30.json',
            ...
            'order_document'    => 'orders_get.json',
    ...
    private static function production(): array
    {
        return [
            ...
            'product_related'   => 'artikli/dodaci/lista',
            'product_action_30' => 'artiklipopusti/lista',
