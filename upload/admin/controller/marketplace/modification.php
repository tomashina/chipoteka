...
class ControllerMarketplaceModification extends Controller {
    ...
    public function refreshcron($data = array()) {
        $this->load->language('marketplace/modification');
	...
	protected function getList() {
        ...
        $data['refreshcron'] = $this->url->link('marketplace/modification/refreshcron', 'user_token=' . $this->session->data['user_token'] . $url, true);
