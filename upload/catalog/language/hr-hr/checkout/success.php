...
$_['text_pouzece_poslovnica']           = '<p>Uredno smo zaprimili Vašu rezervaciju broj  %s</p><p>Naš tim u poslovnici će je obraditi u najbržem mogućem roku.
</p><p>Plaćanje na blagajni poslovnice u iznosu od %s.</p><p>Kako Ugovor nije sklopljen na daljinu (preuzimanje i plaćanje rezervacije u poslovnici), jednostrani raskid ugovora unutar 14 dana od preuzimanja rezervacije se ne primjenjuje.</p>';
...
MODEL: 05 POZIV NA BROJ: %s<br> PRIMATELJ: Z-EL D.O.O.</p>

<p>ILI JEDNOSTAVNO POSKENIRAJTE 2D BARKOD</p>';

$_['text_bank_rezervacija']           = '<p>Uredno smo zaprimili Vašu rezervaciju broj %s i zahvaljujemo Vam.</p><p>Molimo vas da izvršite uplatu po sljedećim uputama za plaćanje.</p><p> Rok za uplatu je maksimalno 48h tijekom koga robu koju ste naručili držimo rezerviranu za vas.</p><p> Ukoliko u tom roku ne zaprimimo uplatu, nažalost moramo poništiti ovu rezervaciju.</p><p>MOLIMO IZVRŠITE UPLATU U IZNOSU OD %s <br>
IBAN RAČUN: HR4424070001100582698<br>
MODEL: 05 POZIV NA BROJ: %s<br> PRIMATELJ: Z-EL D.O.O.</p>
...
$_['text_rezervacija']           = '<p>Uredno smo zaprimili Vašu rezervaciju kao i uplatu za narudžbu broj  %s</p><p>Naš tim u webshopu će je obraditi u najbržem mogućem roku.</p>';
