...
class ModelAccountCustomer extends Model {
    ...
    public function getCustomersByGrupapartnera($grupa_partnera) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE grupa_partnera = '" . $this->db->escape($grupa_partnera) . "'");
